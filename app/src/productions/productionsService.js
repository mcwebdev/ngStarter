(function(){
  ...
  angular.module('productions')
         .service('productionsService', ['$q', productionsService]);

  /**
   * productions DataService
  ...
  function productionsService($q){
    ...
    // Promise-based API
    return {
      loadAllproductions : function() {
        // Simulate async nature of real remote calls
        return $q.when(productions);
      }
    };
  }
